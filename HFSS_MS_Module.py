...
def gen_K_Empty_Squre(H=HFSS_Script.HFSS, l1=float, l2=float, w=float, theta=float, t=0.2):
    H.create_box(str(-l1 * 0.5) + 'mm', str(-l2 * 0.5) + 'mm', '0mm',
                 str(l1) + "mm", str(l2) + "mm", str(t) + 'mm',
                 "L1", _mat='pec')

    H.create_box(str(-l1 * 0.5 + 0.5 * w) + 'mm', str(-l2 * 0.5 + 0.5 * w) + 'mm', '0mm',
                 str(l1 - w) + "mm", str(l2 - w) + "mm", str(t) + 'mm',
                 "L1", _mat='pec')
